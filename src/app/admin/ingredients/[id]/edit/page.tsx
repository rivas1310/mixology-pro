...
export default function EditIngredientPage() {
  ...
  const loadIngredient = useCallback(async () => {
    try {
      ...
      setFormData({
        name: data.name || '',
        type: data.type || 'CITRICOS',
        category: data.category || 'FRUITS',
        description: data.description || '',
        image: data.image || '',
        imageKey: data.imageKey || '',
        season: data.season || 'YEAR_ROUND',
        origin: data.origin || '',
      ...
      if (n && typeof n === 'object' && !Array.isArray(n)) {
        ...
        setNutrition({
          calories: o.calories != null ? String(o.calories) : '',
          vitaminC: o.vitaminC != null ? String(o.vitaminC) : '',
          acidity: o.acidity != null ? String(o.acidity) : '',
          fiber: o.fiber != null ? String(o.fiber) : '',
          sugar: o.sugar != null ? String(o.sugar) : ''
        })
      }
    } catch (e) {
      console.error(e)
      toast.error('Error cargando ingrediente')
      router.push('/admin/ingredients')
    } finally {
      setLoading(false)
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(error.error || 'Error actualizando el ingrediente')
      }
    } catch (error) {
